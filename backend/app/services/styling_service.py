...
def _build_item_image_prompt(
    ...
    return (
        ...
        "Do not add any cards, panels, frames, borders, callouts, arrows, legends, labels, captions, badges, swatches, icons, UI elements, watermarks, or decorative symbols.\n"
        "Do not add any new letters, numbers, words, logos, typography, Chinese characters, or gibberish text anywhere in the image or background.\n"
        "Exception: preserve only the authentic graphics, print, letters, numbers, and logos already visible on the fixed anchor garment in the attached reference image. Do not redesign, translate, replace, or duplicate them.\n"
        "Do not show duplicate people, duplicate garments, extra limbs, cropped body parts, or objects covering the outfit.\n"
        f"{reference_policy}"
